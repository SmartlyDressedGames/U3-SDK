	...
	SubShader
	{
		Pass
		{
			...
			void frag(v2f i, out half4 outDiffuse : COLOR0, out half4 outEmission : COLOR1)
			{
				...
				// 2023-01-31: there seems to be an issue that transparent decals are not visible at nighttime,
				// related to transparent pixels in screenshot. (public issue #3670) Using col.a as emission
				// alpha seems to fix the intensity of the decal. Hopefully no negative side effects...
