...
namespace SDG.Unturned
{
	public class InteractableOxygenator : InteractablePower
	{
		...
		internal static readonly ClientInstanceMethod<bool> SendPowered = ClientInstanceMethod<bool>.Get(typeof(InteractableOxygenator), nameof(ReceivePowered));
		...
		private static readonly ServerInstanceMethod<bool> SendToggleRequest = ServerInstanceMethod<bool>.Get(typeof(InteractableOxygenator), nameof(ReceiveToggleRequest));
